...
namespace Dapper.Contrib.Smartrak.Extensions
{
	/// <summary>
	/// A custom version of Contrib extensions too different to merge in
	/// </summary>
	public static class SqlMapperExtensions
	{
		...
		class ProxyGenerator
		{
			...
			public static T GetInterfaceProxy<T>()
			{
				...
				var interfaceType = typeof(Dapper.Contrib.Smartrak.Extensions.SqlMapperExtensions.IProxy);
			...
			private static MethodInfo CreateIsDirtyProperty(TypeBuilder typeBuilder)
			{
				...
				var getMethod = typeof(Dapper.Contrib.Smartrak.Extensions.SqlMapperExtensions.IProxy).GetMethod("get_" + "IsDirty");
				var setMethod = typeof(Dapper.Contrib.Smartrak.Extensions.SqlMapperExtensions.IProxy).GetMethod("set_" + "IsDirty");
...
public class SqlServerAdapter : ISqlAdapter
{
	...
	public string ColumnNameIndicator { get { return "'"; } }
}
